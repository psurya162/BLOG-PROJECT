...
const Hollywood = () => {
  ...
  // Filter Hollywood posts
  const hollywoodPosts = data.filter((item) => item.category === "HOLLYWOOD");
      ...
      <div className="Main">
        ...
        <div className="Right-side">
            ...
            <div key={index} className="Top-Post-bottom-Big-image">
              ...
              <div className="Top-Post-bottom-name">
                ...
                <p>
                  ...
                  :December 21 2023 <span>{index + 1}</span>
                </p>
              </div>
            </div>
          ))}
          ...
          <div className="Advertisement-Card">
            <img
              src="https://imgs.search.brave.com/OcqN8f7pkz6jan4xXtQdSBoBLIeKIWbrX6YlaPpkieg/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzL2E3L2Jh/L2YxL2E3YmFmMTJl/Yzc3Y2VlNjViY2Iz/NWY1Y2VmMjcyZDZi/LmpwZw"
              alt=""
            />
          </div>
        </div>
